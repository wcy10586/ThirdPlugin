...
public class RouterProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        MethodSpec.Builder mapMethod = MethodSpec.methodBuilder("map")
                ...
                .addStatement("com.yoloho.actrouters.ExtraTypes extraTypes")
                .addCode("\n");
        ...
        for (Element activity : activities) {
            ...
            mapMethod.addStatement("extraTypes = new com.yoloho.actrouters.ExtraTypes()");
            ...
            for (String format : router.value()) {
                mapMethod.addStatement("com.yoloho.actrouters.ActRouters.map($S, $T.class, extraTypes)", format, ClassName.get((TypeElement) activity));
            }
            mapMethod.addCode("\n");
        }
        mapMethod.addStatement("com.yoloho.actrouters.ActRouters.sort()");
        ...
        TypeSpec routerMapping = TypeSpec.classBuilder("RouterMapping")
                ...
                .build();
        try {
            JavaFile.builder("com.yoloho.actrouters", routerMapping)
                    .build()
                    .writeTo(filer);
        } catch (Throwable e) {
            e.printStackTrace();
